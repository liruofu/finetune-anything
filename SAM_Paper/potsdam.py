...
def parse_args():
    ...
    parser.add_argument('-dataset_path', default="/home/yelu/ICPR_CV/potsdam/Potsdam/1_DSM_normalisation.zip", help='potsdam folder path')
    parser.add_argument('--tmp_dir', help='path of the temporary directory')
    parser.add_argument('-o', '--out_dir', default="/home/yelu/ICPR_CV/potsdam/cropped_Potsdam_dsm", help='output path')
    parser.add_argument(
        '--clip_size',
        type=int,
...
def clip_big_image(image_path, clip_save_dir, args, to_label=False):
    ...
    # For example, given one 5120 x 5120 image, the clip size is
